...
export const EditorPanel: React.FC<EditorPanelProps> = ({ state, onChange }) => {
  return (
    <div className="w-full md:w-80 bg-brand-panel border-l border-gray-700 flex flex-col h-full overflow-y-auto z-20 shadow-xl custom-scrollbar">
      <div className="p-5 border-b border-gray-700">
        <h2 className="text-lg font-bold text-white">Design Editor</h2>
        <p className="text-xs text-gray-400">Customize layout & appearance</p>
      </div>
      ...
      <div className="p-5 space-y-8 pb-20">
        ...
        <div className="space-y-4">
            ...
            <div>
                ...
                <input 
                    ...
                    className="w-full h-1 bg-gray-600 rounded-lg appearance-none cursor-pointer accent-brand-accent"
                />
            </div>

            <div>
                <div className="flex justify-between mb-1">
                    <label className="text-sm text-gray-300">Vertical Shift</label>
        ...
        <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-2">
               <div>
                  <label className="text-xs text-gray-400 block mb-1">Horiz. Pos</label>
                  <input 
                      type="range" 
                      min="-400" 
                      max="400" 
               ...
               <div>
                  <label className="text-xs text-gray-400 block mb-1">Vert. Pos</label>
                  <input 
                      type="range" 
                      min="-400" 
                      max="400" 
        ...
        <hr className="border-gray-700" />
         ...
         <div>
            <div className="flex justify-between mb-1">
                <label className="text-sm text-gray-300">Safe Zone Padding</label>
